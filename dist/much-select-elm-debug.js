...
var $author$project$MuchSelect$init = function (flags) {
	...
	return _Utils_Tuple2(
		{
			focusedIndex: 0,
			getOptionsFromTheDomBounce: $grotsev$elm_debouncer$Bounce$init,
...
var $author$project$MuchSelect$RequestAllOptionsSteady = {$: 'RequestAllOptionsSteady'};
...
var $author$project$MuchSelect$perform = function (effect) {
	switch (effect.$) {
		...
		case 'FetchOptionsFromDom':
			return A2($grotsev$elm_debouncer$Bounce$delay, 100, $author$project$MuchSelect$RequestAllOptionsSteady);
		case 'FetchOptionsForDomSteady':
...
var $author$project$MuchSelect$FetchOptionsForDomSteady = {$: 'FetchOptionsForDomSteady'};
...
var $author$project$MuchSelect$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'RequestAllOptionsSteady':
				return _Utils_Tuple2(model, $author$project$MuchSelect$FetchOptionsForDomSteady);
				...
				if (_v23.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								getOptionsFromTheDomBounce: $grotsev$elm_debouncer$Bounce$push(model.getOptionsFromTheDomBounce),
				...
				switch (attributeName) {
					...
					case 'selected-value':
						...
						if (_v40.$ === 'Ok') {
							...
							var _v41 = A2(
								$elm$core$Debug$log,
								'OptionsUtilities.selectedOptionValuesAreEqual',
								A2($author$project$OptionsUtilities$selectedOptionValuesAreEqual, selectedValueStrings, model.options));
							var _v42 = A2($elm$core$Debug$log, 'selectedValueStrings', selectedValueStrings);
							var _v43 = A2($elm$core$Debug$log, 'model.options', model.options);
